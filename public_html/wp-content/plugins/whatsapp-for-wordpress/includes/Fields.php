...
class Fields {
	...
	public static function getWidgetDisplay() {
		return wp_parse_args(
			...
			array(
				...
				'displayPostCondition' => 'showAllPost',
				'includePages'         => array(),
				'excludePages'         => array(),
				'includePosts'         => array(),
				'excludePosts'         => array(),
	...
	public static function getAccountsSettings() {
		return wp_parse_args(
			get_option( 'nta_wa_accounts', array() ),
			array(
				'hideOfflineAgents' => 'OFF',
			)
		);
	}
