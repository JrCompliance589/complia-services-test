		...
		<tr>   
			...
			<td>
				<div class="nta-wa-built-in-feature">
					<div class="nta-wa-switch-control">
						<input type="checkbox" id="nta-wa-dokan-enabled-switch" name="enableDokanVendorButton" <?php checked( $option['enableDokanVendorButton'], 'ON' ); ?>>
						<label for="nta-wa-dokan-enabled-switch" class="green <?php echo ! $activate_dokan_plugin ? esc_attr( 'njt-wa-dokan-enabled-switch-tooltip' ) : ''; ?>"></label>
					</div>
...
<p class="nta-wa-notice <?php echo 'OFF' === $option['enableDokanVendorButton'] ? esc_attr( 'hidden' ) : ''; ?>">
	<span><?php echo esc_html( 'Please config your WooCommerce Button in ', 'ninjateam-whatsapp' ); ?></span>
	<a class="nta-wa-config-link" href="<?php echo home_url() . '/dashboard/settings/whatsapp/'; ?>" target="_blank"><?php echo __( 'Dokan Vendor Dashboard > Settings > WhatsApp.', 'ninjateam-whatsapp' ); ?></a>
</p>

<button class="button button-large button-primary wa-save"><span class="wa-save-text"><?php esc_html_e( 'Save Changes', 'ninjateam-whatsapp' ); ?><span></span></span></button>
