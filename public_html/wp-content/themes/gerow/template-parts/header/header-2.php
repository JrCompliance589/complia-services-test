...
$gerow_header_linkedin = get_theme_mod('gerow_header_linkedin', __('#', 'gerow'));
$gerow_header_pinterest = get_theme_mod('gerow_header_pinterest', __('#', 'gerow'));
$gerow_header_youtube = get_theme_mod('gerow_header_youtube', __('#', 'gerow'));
$gerow_header_telegram = get_theme_mod('gerow_header_telegram', __('#', 'gerow'));
$gerow_header_github = get_theme_mod('gerow_header_github', __('#', 'gerow'));
...
<!-- header-area -->
<header id="<?php echo esc_attr($sticky_header); ?>" class="transparent-header header-style-two">
                                ...
                                <div class="header-social">
                                    <ul class="list-wrap">
                                        ...
                                        <?php if (!empty($gerow_header_twitter)) : ?>
                                            <li>
                                                <a href="<?php echo esc_url($gerow_header_twitter); ?>">
                                        ...
                                        <?php if (!empty($gerow_header_linkedin)) : ?>
                                            <li><a href="<?php echo esc_url($gerow_header_linkedin); ?>"><i class="fab fa-linkedin-in"></i></a></li>
                                        <?php endif; ?>
                                        ...
                                        <?php if (!empty($gerow_header_youtube)) : ?>
                                            <li><a href="<?php echo esc_url($gerow_header_youtube); ?>"><i class="fab fa-youtube"></i></a></li>
                                        <?php endif; ?>

                                        <?php if (!empty($gerow_header_telegram)) : ?>
                                            <li><a href="<?php echo esc_url($gerow_header_telegram); ?>"><i class="fab fa-telegram-plane"></i></a></li>
                                        <?php endif; ?>

                                        <?php if (!empty($gerow_header_github)) : ?>
                                            <li><a href="<?php echo esc_url($gerow_header_github); ?>"><i class="fab fa-github"></i></a></li>
                                        <?php endif; ?>
