...
$gerow_audio_url = function_exists('get_field') ? get_field('fromate_style') : NULL;
...
<?php if (is_single()) : ?>
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('blog-post-item-two blog-details-wrap format-audio'); ?>>

        <?php if (!empty($gerow_audio_url)) : ?>
            <div class="blog-details-thumb postbox__audio ratio ratio-16x9">
                <?php echo wp_oembed_get($gerow_audio_url); ?>
            </div>
        <?php endif; ?>
...
<?php else : ?>
    ...
    <div class="col-md-6 grid-item">
        <article id="post-<?php the_ID(); ?>" <?php post_class('blog-post-item-two format-audio'); ?>>

            <?php if (!empty($gerow_audio_url)) : ?>
                <div class="blog-post-thumb-two postbox__audio ratio ratio-16x9">
                    <?php echo wp_oembed_get($gerow_audio_url); ?>
