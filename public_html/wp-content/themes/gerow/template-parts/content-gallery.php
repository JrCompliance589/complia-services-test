...
<?php if (is_single()) : ?>
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('blog-post-item-two blog-details-wrap format-gallery'); ?>>

        <?php if (has_post_thumbnail()) : ?>
            <div class="blog-details-thumb blog-post-thumb-active">
...
<?php else : ?>
    ...
    <div class="col-md-6 grid-item">
        <article id="post-<?php the_ID(); ?>" <?php post_class('blog-post-item-two format-gallery'); ?>>

            <?php if (!empty($gallery_images)) : ?>
                <div class="blog-post-thumb-two blog-post-thumb-active">
                    <?php foreach ($gallery_images as $key => $image) :  ?>
                        <img src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>">
                    <?php endforeach; ?>
