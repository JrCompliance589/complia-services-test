...
<?php if (is_single()) : ?>
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('blog-post-item-two blog-details-wrap format-search'); ?>>
...
<?php else : ?>
    ...
    <div class="col-md-6 grid-item">
        <article id="post-<?php the_ID(); ?>" <?php post_class('blog-post-item-two format-search'); ?>>
