...
function gerow_breadcrumb_func()
{
    ...
    if (empty($is_breadcrumb) && $breadcrumb_show == 1) {
        ...
        $breadcrumb_background = get_theme_mod('breadcrumb_bg_img');
    ...
    ?>
        ...
        <?php if (!empty($breadcrumb_hide_default)) : ?>
            <!-- breadcrumb-area -->
            <section class="breadcrumb-area breadcrumb-bg <?php print esc_attr($breadcrumb_class); ?>" data-background="<?php print esc_attr($breadcrumb_background); ?>">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
