...
function _header_top_fields( $fields ) {
    ...
    $fields[] = [
        'type'     => 'text',
        'settings' => 'gerow_header_linkedin',
        'label'    => esc_html__('Enter Linkedin url', 'gerow'),
        'section'  => 'header_top_setting',
        'priority' => 10,
        'active_callback'  => [
            [
    ...
    $fields[] = [
        'type'     => 'text',
        'settings' => 'gerow_header_youtube',
        'label'    => esc_html__('Enter Youtube url', 'gerow'),
        'section'  => 'header_top_setting',
        'priority' => 10,
        'active_callback'  => [
            [
    ...
    $fields[] = [
        'type'     => 'text',
        'settings' => 'gerow_header_telegram',
        'label'    => esc_html__('Enter Telegram url', 'gerow'),
        'section'  => 'header_top_setting',
        'priority' => 10,
        'active_callback'  => [
            [
    ...
    $fields[] = [
        'type'     => 'text',
        'settings' => 'gerow_header_github',
        'label'    => esc_html__('Enter Github url', 'gerow'),
        'section'  => 'header_top_setting',
        'priority' => 10,
        'active_callback'  => [
            [
...
function gerow_color_fields( $fields ) {
    ...
    $fields[] = [
        'type'        => 'color',
        'settings'    => 'gerow_color_option3',
        'label'       => __('Button Hover Color', 'gerow' ),
        'description' => esc_html__('This is a Button Hover color control.', 'gerow' ),
        'section'     => 'color_setting',
        'default'     => '#0049DC',
        'priority'    => 10,
    ];
    ...
    $fields[] = [
        'type'        => 'color',
        'settings'    => 'gerow_color_option4',
        'label'       => __('Light Blue Color', 'gerow' ),
        'description' => esc_html__('This is a Light Blue color control.', 'gerow' ),
        'section'     => 'color_setting',
        'default'     => '#E6EEFF',
        'priority'    => 10,
    ];
...
function gerow_typo_fields( $fields ) {
    ...
    $fields[] = [
        ...
        'label'       => esc_html__( 'Heading Fonts', 'gerow' ),
        'section'     => 'typo_setting',
        'default'     => [
            'font-family'    => '',
            'variant'        => '',
...
function gerow_slug_setting( $fields ) {
    ...
    $fields[] = [
        'type'     => 'text',
        'settings' => 'gerow_services_slug',
        'label'    => esc_html__( 'Services Slug', 'gerow' ),
        'section'  => 'slug_setting',
        'default'  => esc_html__('services', 'gerow' ),
        'priority' => 10,
    ];

    $fields[] = [
        'type'     => 'text',
        'settings' => 'gerow_project_slug',
        'label'    => esc_html__( 'Project Slug', 'gerow' ),
        'section'  => 'slug_setting',
        'default'  => esc_html__('project', 'gerow' ),
        'priority' => 10,
    ];
